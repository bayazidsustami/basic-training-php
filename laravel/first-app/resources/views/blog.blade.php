...
@section('container')
        ...
        <div class="card mb-3">
            ...
            <p><small class="text-muted">
                ...
                <span class="badge bg-primary bg-light text-dark">
                    <a href="/blog?author={{ $blogs[0]->author->name }}" class="text-decoration-none">{{ $blogs[0]->author->name }}</a>
                </span> 
                in 
                <a href="/blog?category={{ $blogs[0]->category->slug }}" class="text-decoration-none"> {{ $blogs[0]->category->name }}</a>
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <div class="position-absolute px-3 py-2 text-white" style="background-color: rgba(0, 0, 0, 0.7)">
                        <a href="/blog?category={{ $blog->category->slug}}" class="text-white text-decoration-none">{{ $blog->category->name }}</a>
                    </div>
                    ...
                    <p><small class="text-muted">
                            By : 
                            <span class="badge bg-primary bg-light text-dark">
                                <a href="/blog?author={{ $blog->author->name }}" class="text-decoration-none">{{ $blog->author->name }}</a>
                            </span> 
    ...
    <div class="container">
        <div class="row justify-content-center mb-5">
            ...
            <lottie-player class="center" src="https://assets3.lottiefiles.com/packages/lf20_scgyykem.json"  background="transparent"  speed="1"  style="width: 300px; height: 300px;"  loop autoplay></lottie-player>
        </div>
    </div>
    @endif
@endsection
